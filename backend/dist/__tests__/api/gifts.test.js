...
const route_1 = require("@/app/api/gifts/route");
...
describe("POST /api/gifts", () => {
    ...
    it("should create a gift successfully with valid data", async () => {
        ...
        const request = new server_1.NextRequest("http://localhost/api/gifts", {
            method: "POST",
            headers: {
    ...
    it("should accept valid ISO 8601 with offset timezone for unlock_at", async () => {
        ...
        const adjustedDate = new Date(threeHoursFromNow.getTime() - 1 * 60 * 60 * 1000);
