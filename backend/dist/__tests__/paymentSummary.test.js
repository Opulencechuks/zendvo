...
const paymentSummary_1 = require("@/lib/paymentSummary");
describe("createPaymentSummary", () => {
    it("calculates a complete Stripe fee breakdown for USD", () => {
        expect((0, paymentSummary_1.createPaymentSummary)(100, "usd", "stripe")).toEqual({
    ...
    it("applies Paystack percentage and flat NGN fee", () => {
        expect((0, paymentSummary_1.createPaymentSummary)(10000, "ngn", "paystack")).toEqual({
    ...
    it("falls back to the default platform rate for unsupported currencies", () => {
        expect((0, paymentSummary_1.createPaymentSummary)(50, "eur", "stripe")).toEqual({
    ...
    it("rounds fractional amounts consistently", () => {
        expect((0, paymentSummary_1.createPaymentSummary)(12.345, "usd", "stripe")).toEqual({
    ...
    it("rejects invalid base amounts", () => {
        expect(() => (0, paymentSummary_1.createPaymentSummary)(-1, "usd", "stripe")).toThrow("Base amount must be a non-negative finite number");
    });
    it("rejects blank currencies", () => {
        expect(() => (0, paymentSummary_1.createPaymentSummary)(10, "   ", "stripe")).toThrow("Currency is required");
    });
});
